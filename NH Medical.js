...
for (var i = 1; i < rows.length; i++) {
	...
	if (no_detail[0] == undefined) {
		...
		if (labels_a[2].textContent == 'Address:') {
			var name_ = values_[0].textContent;
			var address_1 = values_[1].textContent;
			var city_ = values_[2].textContent;
			var county_ = values_[3].textContent;
			var zip_ = values_[4].textContent;
			var state_ = values_[5].textContent;
			var phone_ = values_[6].textContent;
			var number_ = values_[7].textContent;
			var profession_ = values_[8].textContent;
			...
			var disc_ = disc_a[6].textContent;
		} else {
			var name_ = values_[0].textContent;
			var address_1 = '';
			var address_2 = '';
			...
			var disc_ = disc_a[5].textContent;
		}
	} else {
