...
if (rows[0] != undefined) {
	for (let i = 0; i < rows.length; i++) {
		...
		let state_ = values_[1].textContent;
		let zip_ = values_[2].textContent;
		let city_ = values_[3].textContent;
		let number_ = values_[4].textContent;
		let type_ = values_[5].textContent;
		let status_ = values_[6].textContent;
		let lid_ = values_[7].textContent;
		let led_ = values_[9].textContent;
