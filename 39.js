...
var header_a = ['Full Name','First Name','Last Name','License Type','License Number','License Status','License Issue Date','License Expiration Date','Specialty'];
...
if (rows[1] != undefined) {
	for (var i = 1; i < rows.length; i++) {
		...
		var specialty_ = values_[6].textContent;
		[full_name_,first_name_,last_name_,type_,number_,status_,lid_,led_,specialty_].forEach(x => lic_.insertCell(-1).textContent = x);
