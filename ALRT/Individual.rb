...
1 - Go to https://igovsolution.net/asbrtonline/Lookups/Individual.aspx
...
uri = URI.parse("https://asbrt.igovsolution.net/online/WCFGrid/Grid.svc/GetIndv_license")
...
request["Referer"] = "https://igovsolution.net/asbrtonline/Lookups/Individual.aspx"
