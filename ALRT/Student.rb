...
1 - Go to https://igovsolution.net/asbrtonline/Lookups/Students.aspx

2 - Open Network Monitoring F12

3 - Perform a search

4 - Copy the cURL of your net request Get_StudentSearch
...
uri = URI.parse("https://asbrt.igovsolution.net/online/WCFGrid/Grid.svc/Get_StudentSearch")
request = Net::HTTP::Post.new(uri)
request.content_type = "application/json; charset=UTF-8"
request["Cookie"] = "ASP.NET_SessionId="+cookie_monster_
request["Origin"] = "https://igovsolution.net"
request["Accept-Language"] = "en-US,en;q=0.9"
request["User-Agent"] = user_agent_
request["Accept"] = "application/json, text/javascript, */*; q=0.01"
request["Referer"] = "https://igovsolution.net/asbrtonline/Lookups/Students.aspx"
...
redacted_ = {"Student_ID":"redacted", "FirstName":"redacted", "LastName":"redacted", "Name":"redacted", "Programme":"redacted", "Enrolled":"redacted", "Employinginstitution":"redacted", "Notes":"redacted", "Graduationdate":"redacted", "CreatedDate":"redacted", "Modifydate":"redacted", "CreatedBy":"redacted", "ModifyBy":"redacted"}

File.open("828S.json", "w+") do |h|
