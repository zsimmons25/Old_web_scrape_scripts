...
rows[0].insertCell(-1).textContent = 'Address 1'; rows[0].insertCell(-1).textContent = 'Address 2'; rows[0].insertCell(-1).textContent = 'Issue Date'; rows[0].insertCell(-1).textContent = 'Expiartion Date';
...
for (var i = 1; i < rows.length; i++) {
	...
	rows[i].insertCell(-1).textContent = address_1; rows[i].insertCell(-1).textContent = address_2; rows[i].insertCell(-1).textContent = lid_; rows[i].insertCell(-1).textContent = expire_;
